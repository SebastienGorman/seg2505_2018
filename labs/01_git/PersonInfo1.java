public class PersonInfo1 {
    ...
    public static String firstName = "Sébastien";
    public static String lastName = "Gorman";
    public static int studentNo = 300023785;
    public static String description = "Short guy";
